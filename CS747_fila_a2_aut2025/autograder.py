    ...
    def __init__(self,algorithm,print_error):
        ...
        for algo in algorithm_ls:
            ...
            for in_file in input_file_ls:
                print("\n\n","-"*100)
                if algo == 'default':
                    cmd_planner = r"python","planner.py","--mdp",in_file
                else:
                    cmd_planner = r"python","planner.py","--mdp",in_file,"--algorithm",algo
        ...
        for in_file in policy_eval_files:
            cmd_planner = r"python","planner.py","--mdp",in_file, "--policy", in_file.replace("continuing","policy-continuing").replace("episodic","policy-episodic")
...
def run(gameconfig, test):
    ...
    cmd_planner = r"python","planner.py","--mdp","verify_attt_mdp"
